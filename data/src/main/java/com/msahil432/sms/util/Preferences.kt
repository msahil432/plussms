package com.msahil432.sms.util
...
class Preferences @Inject constructor(private val rxPrefs: RxSharedPreferences) {
    ...
    val notifAction1 = rxPrefs.getInteger("notifAction1", NOTIFICATION_ACTION_REPLY)
    val notifAction2 = rxPrefs.getInteger("notifAction2", NOTIFICATION_ACTION_READ)
