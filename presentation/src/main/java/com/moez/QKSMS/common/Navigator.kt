...
class Navigator @Inject constructor(
    ...
    fun showConversation(threadId: Long, category: String? = null, query: String? = null) {
        val intent = Intent(context, ComposeActivity::class.java)
    ...
    fun showDeveloper() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/msahil432"))
        startActivity(intent)
    }

    fun showSourceCode() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/msahil432/plussms"))
        startActivity(intent)
    }
    ...
    fun showSupport() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("dev@msahil432.com"))
        intent.putExtra(Intent.EXTRA_SUBJECT, "PlusSMS Support")
    ...
    fun showInvite() {
        ...
        Intent(Intent.ACTION_SEND)
                .setType("text/plain")
                .putExtra(Intent.EXTRA_TEXT, "Try the new PlusSMS Application which categorizes your SMS into different categories to ease your life. Test it out now, Visit: https://play.google.com/apps/testing/com.msahil432.sms")
    ...
    fun showNotificationChannel(channelId: String) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val intent = Intent(Settings.ACTION_CHANNEL_NOTIFICATION_SETTINGS)
            intent.putExtra(Settings.EXTRA_CHANNEL_ID, channelId)
            intent.putExtra(Settings.EXTRA_APP_PACKAGE, context.packageName)
