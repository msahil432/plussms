        ...
        view.preferenceClickIntent
                ...
                .subscribe {
                    when (it.id) {
                        ...
                        R.id.updates_notifications ->
                            navigator.showNotificationChannel(NotificationManagerImpl.UPDATES_CHANNEL_ID)

                        R.id.other_notifications ->
                            navigator.showNotificationChannel(NotificationManagerImpl.OTHERS_CHANNEL_ID)
